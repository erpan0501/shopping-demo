package com.localdemo.shopping_user_service.util;
...
public class JwtUtils {
    ...
    public static Map<String, Object> verify(String token){
        ...
        JwtConsumer jwtConsumer = new JwtConsumerBuilder()
                ...
                .setExpectedIssuer("localdemo") // jwt需要知道谁发布得 用来验证发布人
    ...
    public static void main(String[] args){
        // 生成
        String localdemo = sign(1001L, "localdemo");
        System.out.println(localdemo);

        Map<String, Object> stringObjectMap = verify(localdemo);
